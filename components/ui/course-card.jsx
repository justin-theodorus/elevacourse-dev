...
export function CourseCard({
  ...
  return (
    <div className="bg-[#0976ECBA]  rounded-2xl overflow-hidden">
      <div className="flex">
          <div className="bg-[#0976EC] p-8 flex items-center justify-center">
        ...
        <div className="flex-1 p-8 text-white">
          ...
          <div className="flex items-end justify-between mt-8">
            ...
            <Link href="/lesson">
              <Button className="bg-blue-600 text-white hover:bg-blue-500 px-6 py-2 rounded-full font-medium shadow-md">
                Continue
              </Button>
            </Link>
          </div>
