      ...
      <main className={`transition-all duration-300 ${sidebarExpanded ? 'ml-64' : 'ml-20'}`}>
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            {/* ================= LEFT CONTENT (2 kolom di desktop) ================= */}
            <div className="xl:col-span-2">
              ...
              <section className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-3xl font-bold text-blue-500">Courses</h2>
              ...
              <section>
                <h2 className="text-3xl font-bold text-blue-500 mb-6">Last Lesson Accessed</h2>
                <div className="space-y-4">
                  {recentLessons.map((lesson) => (
                    <div
                      key={lesson.id}
                      className="bg-[#0976ECBA] rounded-2xl p-6 text-white"
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <Button 
                            className="bg-blue-500 text-white hover:bg-blue-600 px-6 py-2 rounded-full font-medium shadow-md"
            ...
            {/* ================= RIGHT SIDEBAR (1 kolom di desktop, hidden di hp) ================= */}
